<template>
    <div>
        <h2>{{movie.title}}<span style="color: lightgray">({{movie.publishDate}})</span></h2>
        <el-row type="flex" justify="center" :gutter="20">
            <el-col :span="5">
                <img src="../assets/1.jpg" style="width: 135px;height: 200px">
            </el-col>
            <el-col :span="8" style="text-align: left">
                ...
                <div>
                    ...
                    <template v-for="(a,index) in movie.author">
                        <span class="author" style="color: #37a">{{a}}</span>
        ...
        <el-row style="text-align: left;font-size: 12px" v-for="comment in movie.comments">
            <el-col :span="16" :offset="4">
                ...
                <div>
                    ...
                    <span style="position:relative;left:55%">{{comment.zan}}有用</span>
                </div>
                <p>
                    {{comment.content}}
                </p>
...
<script>
    ...
    export default {
        components: {
            ...
            ElRow},
        /**
         * 当detail。vue被加载时，首先执行create函数，实际上指的是页面未加载完成前，，先执行的函数
         * 当生命周期钩子函数
         */
        created:function () {
            //先给movie对象附上title的值
